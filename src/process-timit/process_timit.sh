...
python3 $CODE_DIR/create_video_list.py $FEATURE_DIR/train_video_list $TIMIT_DIR train  
python3 $CODE_DIR/create_video_list.py $FEATURE_DIR/test_video_list  $TIMIT_DIR test 
...
python3 $CODE_DIR/gather.py $FEATURE_DIR $TIMIT_DIR train
python3 $CODE_DIR/gather.py $FEATURE_DIR $TIMIT_DIR test

python3$CODE_DIR/nor.py $FEATURE_DIR/processed
